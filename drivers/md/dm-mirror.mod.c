...
__attribute__((section("__versions"))) = {
	...
	{ 0x60783384, __VMLINUX_SYMBOL_STR(dm_region_hash_create) },
	...
	{ 0xf81eb5b2, __VMLINUX_SYMBOL_STR(dm_rh_dirty_log) },
	...
	{ 0x4c10c68a, __VMLINUX_SYMBOL_STR(dm_dirty_log_create) },
