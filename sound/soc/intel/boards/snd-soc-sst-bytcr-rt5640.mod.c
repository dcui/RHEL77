...
__attribute__((section("__versions"))) = {
	...
	{ 0x55246bed, __VMLINUX_SYMBOL_STR(rt5640_sel_asrc_clk_src) },
	{ 0xdeb96480, __VMLINUX_SYMBOL_STR(snd_soc_dai_set_fmt) },
	{ 0x49c104dd, __VMLINUX_SYMBOL_STR(rt5640_dmic_enable) },
...
MODULE_INFO(srcversion, "BA76F0ACDC3E889D7BB233C");
